    ...
    public partial class createDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "", "3c6049d4-b645-43ca-bec4-c728de3496d4", new DateTime(2023, 11, 3, 3, 0, 36, 810, DateTimeKind.Local).AddTicks(3476), 0.0, "User", new DateTime(2002, 3, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "customer1@gmail.com", false, "Customer", "Male", true, "Customer", null, false, null, null, "customer1", "AQAAAAEAACcQAAAAEP2Au5XPdD26EwzKUz1aVYathdenbCi9xAnmDbCcTXdIXOZSYyG6lzJ5OtC9ACC0lw==", "1234567890", false, "f56a1aaf-262b-4969-a404-5bcd32d4d8c3", 0.0, false, "customer1" },
                    { "2", 0, "", "f6a1d683-93c1-4a13-b002-763fe7c62c4f", new DateTime(2023, 11, 3, 3, 0, 36, 810, DateTimeKind.Local).AddTicks(3496), 0.0, "User", new DateTime(2002, 8, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "assistant1@gmail.com", false, "Assistant", "Female", true, "Assistant", null, false, null, null, "assistant1", "AQAAAAEAACcQAAAAEHT0U/DWw1/GRS3fGNDVnHC9v3nVOqKi8XwJ6bPDTSu6AP47vMQ4irB8tmNX5ajs1g==", "1234567890", false, "7d767a1e-9a7e-4c3b-8691-2f513ff69b3f", 0.0, false, "assistant1" },
                    { "3", 0, "", "af5dd8d0-09ad-41c0-8567-0eba59ea2a0a", new DateTime(2023, 11, 3, 3, 0, 36, 810, DateTimeKind.Local).AddTicks(3510), 0.0, "User", new DateTime(2000, 5, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "manager1@gmail.com", false, "Manager", "Male", true, "Manager", null, false, null, null, "manager1", "AQAAAAEAACcQAAAAEORVy2k6KkCvlVaR0FtHnILC9GkOpKZE+YfS3GPEsyy70uqfiPWr1JAdb/wEcF851w==", "1234567890", false, "9dc83f9f-9416-4c31-9671-4d31e90aa0a2", 0.0, false, "manager1" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "1", "Create account successfully +500 points", new DateTime(2023, 11, 3, 3, 0, 36, 832, DateTimeKind.Local).AddTicks(1113), 500 });

            migrationBuilder.InsertData(
                table: "Repositories",
                columns: new[] { "RepositoryId", "AddressId", "Capacity", "CreationDate", "IsFull", "RepositoryName" },
                values: new object[] { 1, 1, 50.0, new DateTime(2023, 11, 3, 3, 0, 36, 833, DateTimeKind.Local).AddTicks(8836), false, "Repository 1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FS-2aab024b-4915-46c9-9f0c-0b459985da6b", 2, " This is testing decription", 1, "Red", 60.0, 40.0, 50.0, 50.0, 2 },
                    { "FS-38ad95fc-3ca3-4331-9c11-862ac2609812", 2, " This is testing decription", 2, "Black", 50.0, 30.0, 120.0, 60.0, 1 },
                    { "FS-3e622c54-5c82-493c-8ed0-55dc88476742", 1, " This is testing decription", 1, "Yellow", 50.0, 50.0, 50.0, 50.0, 1 },
                    { "FS-df0fb8e7-f010-4128-9ee4-d5fed4076cb4", 1, " This is testing decription", 2, "Purple", 30.0, 70.0, 320.0, 20.0, 2 }
                });
