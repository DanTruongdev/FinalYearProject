    ...
    public partial class createDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "customer.jpg", "24e8e2c0-9046-477b-8936-da8b22569a2d", new DateTime(2023, 10, 1, 21, 58, 10, 205, DateTimeKind.Local).AddTicks(9022), 0.0, "User", new DateTime(2002, 3, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "customer1@gmail.com", false, "Customer", "Male", true, "Customer", null, false, null, null, "customer1", "AQAAAAEAACcQAAAAEBXeuSVVaTUJ4TTX5TCYtsr+cPi2t6e/m4OgSJlx3pfgpL8C7YYvPtNSg3EvVzFUrg==", "1234567890", false, "e79ee6c8-c798-4b6b-bbef-11d4beb25bb7", 0.0, false, "customer1" },
                    { "2", 0, "assistant.jpg", "629d525b-3da6-4d9f-965f-855af09062ad", new DateTime(2023, 10, 1, 21, 58, 10, 205, DateTimeKind.Local).AddTicks(9057), 0.0, "User", new DateTime(2002, 8, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "assistant1@gmail.com", false, "Assistant", "Female", true, "Assistant", null, false, null, null, "assistant1", "AQAAAAEAACcQAAAAEKIoOV6osrOD32V6jEthnDNK2cNYS1p+lZYurehx6mZc/4vrNQ0WUYCEosKDzOi8zg==", "1234567890", false, "ed443da9-1e83-4ec4-904c-88866f1d43e2", 0.0, false, "assistant1" },
                    { "3", 0, "manager.jpg", "8a6d95b5-c05a-414f-99c7-3285ccbfa637", new DateTime(2023, 10, 1, 21, 58, 10, 205, DateTimeKind.Local).AddTicks(9071), 0.0, "User", new DateTime(2000, 5, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "manager1@gmail.com", false, "Manager", "Male", true, "Manager", null, false, null, null, "manager1", "AQAAAAEAACcQAAAAEN76Z/w8HnBZQikPbxD94FgtAPkHNwYKwK0VNj3h1ttjllcjy0s0t95jLlitY/ExyQ==", "1234567890", false, "e5056a74-9a78-4c57-946c-d6b5aee34c0f", 0.0, false, "manager1" },
                    { "4", 0, "admin.jpg", "f33fa360-1f90-4827-827a-62ffdfba9f5b", new DateTime(2023, 10, 1, 21, 58, 10, 205, DateTimeKind.Local).AddTicks(9082), 0.0, "User", new DateTime(2001, 7, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin1@gmail.com", false, "Admin", "Male", true, "Admin", null, false, null, null, "admin1", "AQAAAAEAACcQAAAAEAdT3dS/ry1Cy41ibZB8idOCYgGYXkSU5qxLArwLWsopjUsVTEO692q6rADBab1aXw==", "1234567890", false, "52694593-7241-48d5-9c7b-a73a02085876", 0.0, false, "admin1" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "1", "Create account successfully +500 points", new DateTime(2023, 10, 1, 21, 58, 10, 234, DateTimeKind.Local).AddTicks(5158), 500 });

            migrationBuilder.InsertData(
                table: "Repositories",
                columns: new[] { "RepositoryId", "AddressId", "Capacity", "CreationDate", "RepositoryName" },
                values: new object[] { 1, 1, 50.0, new DateTime(2023, 10, 1, 21, 58, 10, 236, DateTimeKind.Local).AddTicks(722), "Repository 1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FS-06b60577-501c-4b69-afb7-e453a251aec2", 1, " This is testing decription", 2, "Purple", 30.0, 70.0, 320.0, 20.0, 2 },
                    { "FS-9cb73cdd-64d7-4e9e-be5e-5347b4de3967", 2, " This is testing decription", 2, "Black", 50.0, 30.0, 120.0, 60.0, 1 },
                    { "FS-e7b6d6c5-01be-4976-a447-b88b72f68564", 1, " This is testing decription", 1, "Yellow", 50.0, 50.0, 50.0, 50.0, 1 },
                    { "FS-eb152a61-faf7-478b-97c4-7c763352b7b7", 2, " This is testing decription", 1, "Red", 60.0, 40.0, 50.0, 50.0, 2 }
                });
