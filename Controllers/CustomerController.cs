...
namespace OnlineShopping.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public ActionResult TestAuthorize(IFormFile a)
        {
            var t = new FileHandleService();
            return Ok(t.ImageOrVideo(a)) ;
        }

                                                // AUTHORIZATION/ AUTHENTICATION
        [HttpPost("create-account")]
        public async Task<IActionResult> RegisterAccount([FromBody] RegisterUser userInfor) // sua username = email (khong su dung username)
        {
        ...
        [HttpGet("furniture-filter")] //thieu image
        [AllowAnonymous]
        ...
        [HttpGet("get-otp-phonenumber-confirmation")] 
        ...
        //ADD
        [HttpPost("add-customer-phonenumber")]
        [Authorize(Roles = "CUSTOMER")]
        ...
        //UPDATE
        [HttpPut("update-customer-phonenumber")]
        [Authorize(Roles = "CUSTOMER")]
        ...
        //GET
        [HttpGet("get-customize-furniture")]
        [Authorize(Roles = "CUSTOMER")]
        ...
        //CREATE
        [HttpPost("create-customize-furniture")]
        [Authorize(Roles = "CUSTOMER")]
        public async Task<IActionResult> CreateCustomizeFurniture([FromForm] CustomizeFurnitureViewModel userInput)
        {
            ...
            await _dbContext.SaveChangesAsync();
            var addedCustomizeFurniture = await _dbContext.CustomizeFurnitures.OrderBy(cf => cf.CreationDate).LastAsync();
            var newResult = new Result()
            {
                CustomizeFurnitureId = addedCustomizeFurniture.CustomizeFurnitureId,
                Status = "Pending"
            };
        ...
        //UPDATE
        [HttpPut("update-customize-furniture")]
        [Authorize(Roles = "CUSTOMER")]
