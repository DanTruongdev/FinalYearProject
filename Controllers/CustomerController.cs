...
namespace OnlineShopping.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        //public async Task<IActionResult> RegisterAccount([FromBody] RegisterCustomerAccount userInfor) 
        //{
        ...
        //            new Response("Error", result.ToString()));
        //    }
        ...
        //    if (loggedInUser == null || !passwordChecker || !loggedInUser.IsActivated)
        //    {
        //        return Unauthorized();
        //    }
        ...
        public async Task<IActionResult> AddToCart(string furnitureSpecificationId, int quantity)
        {
            ...
            if (cartDetailExist != null)
            {
                ...
                else
                {
                    ...
                    loggedInUser.Cart.CartDetails.FirstOrDefault(cd => cd.CartDetailId == cartDetailExist.CartId).Quantity = quantity;
        ...
        public async Task<IActionResult> GetWishlist()
        {
            ...
            var wishlist = loggedInUser.WishList.WishListDetails.ToList();
        ...
        public async Task<IActionResult> Order(OrderViewModel model)
        {
            ...
            if (loggedInUser.Point.TotalPoint < model.UsedPoint) return BadRequest("The total point is not enough");
        ...
        public async Task<IActionResult> CreationFeedback([FromForm]FeedbackViewModel model)
        {
            ...
            if (!order.Status.Equals("Delivered")) return StatusCode(StatusCodes.Status406NotAcceptable,
                new Response("Error", "Feedback is not available for undelivered order"));
